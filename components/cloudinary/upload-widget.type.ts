...
export interface UploadWidgetForFormProps {
  children?: (options: UploadWidgetForFormPropsChildren) => JSX.Element;
  onError?: UploadWidgetEventCallbackError;
  onSuccess?: UploadWidgetEventCallback;
}
...
export interface UploadWidgetForFormPropsChildren {
  cloudinaryForForm?: any;
  widgetForForm?: UploadWidgetInstance;
  open: Function;
}
